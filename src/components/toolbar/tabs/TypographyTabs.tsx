    ...
    return (
        <div className="space-y-6">
            ...
            <div className="space-y-3">
                ...
                <div className="relative group" tabIndex={0} role="button">
                    <div className="w-full bg-white/5 hover:bg-white/10 border border-white/10 text-left px-4 py-3 rounded-xl flex items-center justify-between transition-all cursor-pointer">
                        <span className="text-lg truncate pr-4" style={{ fontFamily: fontFamily }}>{fontFamily}</span>
                        ...
                        {fonts.map(font => (
                            <button
                                ...
                                className={clsx(
                                    ...
                                    fontFamily === font ? 'bg-white/10 text-white' : 'text-white/40'
                                )}
            ...
            <div className="space-y-4 pt-4 border-t border-white/5">
                <h4 className="text-[10px] font-bold text-white/30 uppercase tracking-[0.1em]">Cor do Texto</h4>
            ...
            <div className="space-y-5 pt-4 border-t border-white/5">
                <h4 className="text-[10px] font-bold text-white/30 uppercase tracking-[0.1em]">Escala de Tamanho</h4>
                ...
                <div className="space-y-2.5">
                    ...
                    <input 
                        ...
                        type="range" min="20" max="300" value={titleSize} 
                ...
                <div className="space-y-2.5">
                    ...
                    <input 
                        ...
                        type="range" min="20" max="300" value={subtitleSize} 
