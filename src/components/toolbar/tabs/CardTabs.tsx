    ...
    return (
        <div className="space-y-6">
             ...
             <div className="space-y-4 pt-4 border-t border-white/5">
                ...
                {layout.showHeader && (
                    <div>
                        <label htmlFor="header-position" className="block text-[10px] text-[var(--text-muted)] mb-1.5 uppercase tracking-wider">Posição do Header</label>
             ...
             <div className="space-y-4 pt-4 border-t border-white/5">
                ...
                <div className="grid grid-cols-2 gap-4">
                    <div>
                        <div className="flex justify-between items-center mb-1">
                            <label htmlFor="card-opacity" className="block text-[10px] text-[var(--text-muted)]">Opacidade</label>
                            <div className="flex items-center gap-1.5">
                                <span className="text-[9px] font-mono text-white/40">{Math.round(layout.opacity * 100)}%</span>
                                <button 
                ...
                <div className="grid grid-cols-2 gap-4">
                    <div>
                        <div className="flex justify-between items-center mb-1">
                            <label htmlFor="card-roundness" className="block text-[10px] text-[var(--text-muted)]">Arredondamento</label>
                            <div className="flex items-center gap-1.5">
                                <span className="text-[9px] font-mono text-white/40">{layout.innerRadius}px</span>
                                <button 
                    ...
                    <div>
                        <div className="flex justify-between items-center mb-1">
                            <label htmlFor="card-padding" className="block text-[10px] text-[var(--text-muted)]">Margem Interna</label>
                            <div className="flex items-center gap-1.5">
                                <span className="text-[9px] font-mono text-white/40">{layout.padding}</span>
                                <button 
             ...
             <div className="space-y-4 pt-4 border-t border-white/5">
                ...
                <div className="flex gap-3">
                    <div className="flex-1">
                         <label htmlFor="shadow-color" className="block text-[10px] text-white/40 mb-1">Sombra</label>
                    ...
                    <div className="flex-1">
                         <div className="flex justify-between items-center mb-1">
                            <label htmlFor="shadow-opacity" className="block text-[10px] text-white/40">Opacidade</label>
                            <div className="flex items-center gap-1.5">
                                <span className="text-[9px] font-mono text-white/40">{Math.round((layout.shadowOpacity ?? 0.25) * 100)}%</span>
                                <button 
                ...
                <div className="grid grid-cols-2 gap-3">
                    <div>
                         <div className="flex justify-between items-center mb-1">
                            <label htmlFor="shadow-x" className="block text-[10px] text-white/40">Posição X</label>
                            <div className="flex items-center gap-1.5">
                                <span className="text-[9px] font-mono text-white/40">{layout.shadowOffsetX ?? 0}px</span>
                                <button 
                         ...
                         <input 
                            ...
                            onChange={(e) => updateLayout('shadowOffsetX', parseInt(e.target.value))} 
                            className="w-full h-1 bg-white/10 rounded-lg appearance-none cursor-pointer accent-white" 
                         />
                    </div>
                    <div>
                         <div className="flex justify-between items-center mb-1">
                            <label htmlFor="shadow-y" className="block text-[10px] text-white/40">Posição Y</label>
                            <div className="flex items-center gap-1.5">
                                <span className="text-[9px] font-mono text-white/40">{layout.shadowOffsetY ?? 25}px</span>
                                <button 
                ...
                <div className="grid grid-cols-2 gap-3">
                    <div>
                         <div className="flex justify-between items-center mb-1">
                            <label htmlFor="shadow-blur" className="block text-[10px] text-white/40">Difusão (Blur)</label>
                            <div className="flex items-center gap-1.5">
                                <span className="text-[9px] font-mono text-white/40">{layout.shadowBlur ?? 50}px</span>
                                <button 
                    ...
                    <div>
                        {/* Empty spacing if needed or another control */}
                    </div>
                </div>
             </div>
