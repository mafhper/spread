      ...
      <div className="max-w-6xl mx-auto relative w-full">
        ...
        <div className="text-center mb-16 sm:mb-20">
          ...
          <p className="text-lg text-white/50 max-w-xl mx-auto">
            Ferramentas poderosas para criar visualizações impressionantes em
            segundos
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
          {features.map((feature, index) => (
            ...
            >
              {/* Icon */}
              <div
                className={`w-11 h-11 sm:w-12 sm:h-12 mx-auto rounded-xl bg-gradient-to-br ${feature.gradient} flex items-center justify-center mb-5 shadow-lg group-hover:scale-110 transition-transform duration-300`}
              >
