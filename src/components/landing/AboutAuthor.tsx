/**
 * About Author Section - Developer profile and other projects
 * 
 * Highlights the developer's philosophy of open, accessible web
 * and invites users to explore other projects.
 */
...
export const AboutAuthor: React.FC = () => {
    return (
        <section id="sobre" className="relative min-h-screen py-20 sm:py-32 px-4 sm:px-6 lg:px-8 bg-zinc-950 flex items-center overflow-hidden snap-start">
            ...
            <div className="max-w-4xl mx-auto relative w-full">
                ...
                <div className="text-center mb-12 sm:mb-16">
                    ...
                    <p className="text-lg sm:text-xl text-white/60 max-w-2xl mx-auto leading-relaxed">
                        ...
                        enriquecida com aplicações feitas com <Heart className="inline w-5 h-5 text-red-400 fill-red-400 mx-1" /> carinho.
                        Ferramentas simples que resolvem problemas reais.
                    </p>
                </div>
                    ...
                    <div className="flex items-start gap-6">
                        ...
                        <div>
                            ...
                            <p className="text-white/50 leading-relaxed mb-4">
                                Todos os meus projetos são open source. Você pode explorar o código, 
                                contribuir, fazer fork, ou simplesmente aprender. A web é de todos.
                            </p>
                            <a 
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                    {projects.map((project, index) => (
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="group relative p-6 sm:p-8 rounded-2xl bg-white/[0.02] border border-white/5 hover:border-white/15 transition-all duration-300 block"
                        >
                            {/* Gradient accent */}
                            <div className={`absolute top-0 left-0 right-0 h-1 bg-gradient-to-r ${project.gradient} rounded-t-2xl opacity-0 group-hover:opacity-100 transition-opacity`} />
                            ...
                            <div className="flex items-start justify-between">
                                ...
                                <ExternalLink size={18} className="text-white/30 group-hover:text-white/60 transition-colors flex-shrink-0 mt-1" />
                            </div>
                        </a>
                    ))}
                </div>
