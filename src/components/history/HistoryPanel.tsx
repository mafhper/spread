                ...
                <div className="p-5 border-b border-white/10 flex items-center justify-between bg-white/5">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-white/50">{history.length} cards salvos</p>
                        </div>
                    </div>
                    <button 
                        onClick={onClose} 
                ...
                <div className="flex-1 overflow-y-auto p-4 space-y-3 custom-scrollbar">
                    {history.length === 0 ? (
                        <div className="text-center py-16 text-white/40">
                            ...
                            <p className="text-xs mt-2 text-white/30">Cards aparecerão aqui após você baixar uma imagem.</p>
                        </div>
                    ) : (
                        history.map(item => (
                            <div 
                                key={item.id} 
                                className="group relative bg-white/5 hover:bg-white/10 border border-white/10 hover:border-white/20 rounded-xl overflow-hidden transition-all cursor-pointer"
                            ...
                            >
                                ...
                                {/* Info */}
                                <div className="p-4">
                                    <h3 className="font-semibold text-sm truncate mb-1 group-hover:text-white transition-colors" title={item.title}>
