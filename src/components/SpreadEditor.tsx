...
export const SpreadEditor: React.FC = () => {
    ...
    const { isWelcomeState: isWelcome, setFullState, updateNestedField, updateField } = useCardStore();
    ...
    if (isWelcome) {
        return (
            <div className="h-screen w-full flex flex-col bg-zinc-950 text-white overflow-hidden">
                ...
                <header className="fixed top-0 left-0 right-0 z-50 px-4 py-3 sm:px-6 sm:py-4 flex justify-between items-center bg-zinc-950/80 backdrop-blur-xl border-b border-white/5">
                    <div className="flex items-center gap-3 sm:gap-4">
                        ...
                        >
                            ...
                            <span className="font-extrabold text-sm sm:text-base tracking-tight bg-clip-text text-transparent bg-gradient-to-b from-white to-white/60">Spread</span>
                        </button>
                    ...
                    >
                        ...
                        <span className="text-xs font-bold uppercase tracking-widest pr-2 hidden md:inline">Histórico</span>
                    </button>
                </header>

                {/* Landing Page Content (scrollable) */}
                <main className="flex-1 pt-16 overflow-y-auto overflow-x-hidden scroll-smooth snap-y snap-mandatory">
                    <LandingPage 
                        inputUrl={inputUrl}
    ...
    return (
        <div className="h-screen w-full flex bg-black text-[var(--text-main)] overflow-hidden">
            {/* Left Sidebar */}
            <div className="z-30 h-full"><Sidebar /></div>
