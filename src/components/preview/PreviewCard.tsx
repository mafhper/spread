...
export const PreviewCard: React.FC = () => {
    ...
    const { 
        title, description, image, favicon, domain, author, template,
        colors,
        layout, fontFamily, titleSize, subtitleSize, textAlign,
        isWelcomeState
    } = state;
            ...
            >
                ...
                {layout.cardAspectRatio !== 'aspect-auto' && (
                    <div 
                        ...
                        style={{ 
                            width: '640px', 
                            height: 'auto',
                            aspectRatio: layout.cardAspectRatio === 'aspect-square' ? '1 / 1' : 
                                         layout.cardAspectRatio === 'aspect-video' ? '16 / 9' :
                                         layout.cardAspectRatio === 'aspect-[4/3]' ? '4 / 3' : 'auto',
                            gridArea: '1 / 1 / 2 / 2'
                        }} 
                    />
                )}
                ...
                <div 
                    ...
                    style={{
                        ...
                        minHeight: layout.cardAspectRatio !== 'aspect-auto' ? '100%' : 'auto'
                    }}
                >
                    ...
                    {!isWelcomeState && layout.showHeader && (
                        <div className={cn(
                            "flex-shrink-0 flex",
                            layout.headerPosition === 'right' ? "justify-end" : "justify-start"
                        )}>
                                ...
                                <div className="absolute inset-0">
                                    <img 
                                        ...
                                        className={cn(
                                            ...
                                            layout.imageFit === 'contain' ? 'object-contain' : 'object-cover'
                                        )}
                                        style={{ 
                                ...
                                <div className={cn(
                                    ...
                                    <h2 
                                        ...
                                        style={{ 
                                            ...
                                            fontStyle: fontFamily.includes('Serif') ? 'italic' : 'normal' 
                                        }}
                                    >
                                        {title}
                                    </h2>
