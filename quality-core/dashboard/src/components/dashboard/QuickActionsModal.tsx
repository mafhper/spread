...
export function QuickActionsModal({ isOpen, onClose }: QuickActionsModalProps) {
  ...
  const actions: QuickAction[] = useMemo(() => {
    ...
    const list: QuickAction[] = [
      {
        id: 'quality-core',
        label: 'Quality Core - Análise Completa',
        description: 'Executa análise completa de qualidade',
        command: 'bun run quality:core',
        icon: '🔬',
        category: 'analysis',
      },
      {
        id: 'quality-core-quick',
        label: 'Quality Core - Análise Rápida',
        description: 'Executa análise rápida de qualidade',
        command: 'bun run quality:core:quick',
        icon: '⚡',
        category: 'analysis',
      },
      {
        ...
        description: 'Análise de performance com Lighthouse',
      ...
      {
        id: 'analysis-bundle',
        label: 'Análise de Bundle',
        description: 'Análise detalhada do bundle size',
        command: 'bun run analysis',
        icon: '📦',
        category: 'analysis',
      },
      {
        id: 'quality-reports-all',
        label: 'Todos os Relatórios',
        description: 'Gera todos os relatórios de qualidade',
        command: 'bun run quality:reports:all',
        icon: '📊',
        category: 'analysis',
      },
      {
        ...
        description: 'Inicia o servidor do dashboard de qualidade',
        command: 'bun run quality:dashboard',
        icon: '📈',
        category: 'analysis',
      },
      {
      ...
      {
        id: 'build-analyze',
        label: 'Build com Análise',
        description: 'Build com análise de bundle',
      ...
      },
      {
        id: 'quality-full',
        label: 'Quality Full',
        description: 'Executa lint, type-check, test e quality:core',
        command: 'bun run quality:full',
        icon: '✨',
        category: 'analysis',
      },
      {
        ...
        label: 'Quality Check',
        description:
          'Verificações de qualidade (lint, type-check, format, test)',
      ...
      },
      {
        ...
        description: 'Formata código com Prettier',
    ...
    const order: Array<QuickAction['category']> = [
      'test',
      'build',
      'analysis',
      'maintenance',
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground mt-0.5">
                Copie e execute comandos localmente
              </p>
            </div>
          </div>
          <button
